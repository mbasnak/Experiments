%Experiment 13, pooled analysis

%This code pools the data from all the flies in experiment 13
...
AFirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp3.mat');
AHighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp4.mat');
ASecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\ActivityAcrossBlocks.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\StateTransitions.png'))

%% Around jump velocities

FirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp3.mat');
HighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp4.mat');
SecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\AverageVelocityChange.png'))

%% distance to the goal

FilesFirstLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\\goalsHighErrorBlockExp3.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\goalsHighErrorBlockExp4.mat');
FilesSecondLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp13\data\*\experimental flies\*\dataFromAnalysis\goalsHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\GoalDist.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\GoalDistAcrossBlocks.png'))
...
saveas(gcf,['Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\GoalEv',num2str(i),'.png'])
end
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\Dist2GoalAllTrials.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp13\globalPlots\Dist2goal.png'))
