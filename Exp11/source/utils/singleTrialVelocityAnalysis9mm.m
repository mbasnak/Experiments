...
%% Smooth the data
    ...
    smoothed.Intx = smoothdata(unwrapped.Intx,'rlowess',25); %to 25 Hz
...
%% Transform to useful systems 
    ...
    deg.Intx = smoothed.Intx * 4.5; % we tranform the pos to mm by scaling the value by the sphere's radius
