function [smoothed,remapPosToDeg,flyPos180] = runOpenLoopAnalysis(rawData,path,trialName)

%This function analyses closed-loop data

%OUTPUT
%smoothed = smoothed position and velocity obtained from the raw fictrac
%data
%remapPosToDeg = position of the stimulus wrapped between -180 and 180 deg
%flyPos180 = position of the fly wrapped between -180 and 180 deg
