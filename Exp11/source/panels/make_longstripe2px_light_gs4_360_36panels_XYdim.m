...
stripe_pattern = [zeros(24, 94), ones(24, 2)]; 
...
directory_name = 'Z:\Wilson Lab\Mel\set_up_building\LED_panels\Panels\panels-matlab_071618\Patterns\mel360_36panels';
str = [directory_name '\Pattern008_longstripe2px_light_gs4_360_36panels_XYdim'];
save(str, 'pattern');