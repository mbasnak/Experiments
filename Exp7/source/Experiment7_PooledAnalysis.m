%Experiment 7, pooled analysis

%This code pools the data from all the flies in experiment 7
...
AFirstMasterBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp3.mat');
AYokedBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\ActivityYoked*.mat');
ASecondMasterBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp5.mat');

for i = 1:length(AFirstMasterBlock)
    ActFirstLE{i} = load(strcat(AFirstMasterBlock(i).folder,'\',AFirstMasterBlock(i).name));
    ActHE{i} = load(strcat(AYokedBlock(i).folder,'\',AYokedBlock(i).name));
    ActSecondLE{i} = load(strcat(ASecondMasterBlock(i).folder,'\',ASecondMasterBlock(i).name));
end
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\ActivityAcrossBlocks.png'))
%% State transitions
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\StateTransitions.png'))

%% Around jump velocities

FirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp3.mat');
HighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\perTrialDataYoked*.mat');
SecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\AverageVelocityChange.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\AverageVelocityProgressionHE.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\AverageVelocityQuantitatively.png'))

%% distance to the goal

FilesFirstLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\goalsHighErrorBlockExp3.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\goalsYoked*.mat');
FilesSecondLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\goalsHighErrorBlockExp5.mat');

%load every file with name %perTrialData, adding to the name the date and
%fly, reading the folder it came from

for i = 1:length(FilesFirstLE)
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\GoalDist.png'))


%Look at the goal per fly across blocks
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\GoalDistAcrossBlocks.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\Dist2GoalAllTrials.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\Dist2goal.png'))


%% Distance to the goal in the 10 sec around the jumps

FilesLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\shortData10secHighErrorBlockExp3.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\shortData10secYoked*.mat');
FilesSecondLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp7\data\*\experimental flies\*\dataFromAnalysis\shortData10secHighErrorBlockExp5.mat');
...
for i = 1:length(FilesLE)
    ...
    shortDataSecondLE{i} = load(strcat(FilesSecondLE(i).folder,'\',FilesSecondLE(i).name));
end

proba10secAll = zeros(0,0);
proba10secAllHE = zeros(0,0);
proba10secAllSecondLE = zeros(0,0);
for i = 1:length(FilesLE)
    ...
    proba10secAllSecondLE = [proba10secAllSecondLE,shortDataSecondLE{1,i}.probaDist10secMoving];
end
...
trials = [1:48*length(shortData)];
imagesc(xaxis,trials,proba10secAll')
colormap(newMap)
colorbar
title('First master block trials')
...
colormap(newMap)
colorbar
title('Yoked block trials')
xlabel('Distance to the goal (deg)'); ylabel('Trial #');

subplot(1,3,3)
imagesc(xaxis,trials,proba10secAllSecondLE')
colormap(newMap)
colorbar
title('Second master block trials')
xlabel('Distance to the goal (deg)'); ylabel('Trial #');

suptitle('Distance to goal 10 sec around jumps');

saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp7\globalPlots\Dist2Goal10secHeatMap.png'))
