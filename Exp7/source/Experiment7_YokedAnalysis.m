...
data.ficTracIntx = -rawData ( : , xFly); %I need to negate the data because the axes in fictrac were inverted
...
if jumpFunction == 34
    load('Z:\Wilson Lab\Mel\Experiments\Exp7\source\panels\masterFunctions\fun1\data.mat');
elseif jumpFunction == 35
    load('Z:\Wilson Lab\Mel\Experiments\Exp7\source\panels\masterFunctions\fun2\data.mat');
elseif jumpFunction == 36
    load('Z:\Wilson Lab\Mel\Experiments\Exp7\source\panels\masterFunctions\fun3\data.mat');
elseif jumpFunction == 37
    load('Z:\Wilson Lab\Mel\Experiments\Exp7\source\panels\masterFunctions\fun4\data.mat');
else
    load('Z:\Wilson Lab\Mel\Experiments\Exp7\source\panels\masterFunctions\fun5\data.mat');
end
