...
AFirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\ActivityLowErrorBlockExp3.mat');
AHighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp4.mat');
ASecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\ActivityLowErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\ActivityAcrossBlocks.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\StateTransitions.png'))

%% Around jump velocities

FirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\perTrialDataLowErrorBlockExp3.mat');
HighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp4.mat');
SecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\perTrialDataLowErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\AverageVelocityChange.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\AverageVelocityProgressionHE.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\AverageVelocityQuantitatively.png'))

%% distance to the goal

FilesFirstLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\goalsLowErrorBlockExp3.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\goalsHighErrorBlockExp4.mat');
FilesSecondLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\goalsLowErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\GoalDist.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\GoalDistAcrossBlocks.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\Dist2GoalAllTrials.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\Dist2goal.png'))


%% Distance to the goal in the 10 sec around the jumps

FilesLE = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\shortData10secLowErrorBlockExp*.mat');
FilesHE = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\shortData10secHighErrorBlockExp4.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\Dist2Goal10secHeatMap.png'))

%% Look at the goal distribution whithin each block and across blocks

GoalEvFirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\goalTrialLowErrorBlockExp3.mat');
GoalEvHighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\goalTrialHighErrorBlockExp4.mat');
GoalEvSecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp5\data\*\experimental flies\*\dataFromAnalysis\goalTrialLowErrorBlockExp5.mat');
...
for i = 1:length(GoalEvHighErrorBlock)
    ...
    saveas(gcf,['Z:\Wilson Lab\Mel\Experiments\Exp5\globalPlots\TrialGoal',num2str(i),'.png'])
end
