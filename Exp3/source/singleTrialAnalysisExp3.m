...
function singleTrialAnalysisExp3(path,file)
...
saveas(gcf,strcat(path,'plots\ForwardVelocity.png'))
close;
...
saveas(gcf,strcat(path,'plots\AngularVelocity.png'))
close;
...
saveas(gcf,strcat(path,'plots\ActivityRP.png'))
close;
...
saveas(gcf,strcat(path,'plots\BarPosition.png'))
close;
...
saveas(gcf,strcat(path,'plots\FlyPosition.png'))
close;
...
%save the goal data
save(strcat(path,'dataFromAnalysis\goals.mat'),'goal','goalMoving','dist2goal','dist2goalMoving','goalMoving300sec','dist2goalMoving300sec');
...
for i = 1:length(j)-1
   ...
   saveas(gcf,strcat(path,'plots\Dist2goal100sec.png'))
   close;
...
colormap(newMap)
colorbar
saveas(gcf,strcat(path,'plots\HeatMapDist2goal100sec.png'))
close;
