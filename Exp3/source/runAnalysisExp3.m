...
cd 'Z:\Wilson Lab\Mel\Experiments\Exp3\data'
path = 'Z:\Wilson Lab\Mel\Experiments\Exp3\data\';
        ...
        for j = 1:length(flies)
            if strfind(flies(j).name,'flyNum') ~=0
                ...
                for t = 1:length(trials)
                    ...
                    singleTrialAnalysisExp3(NewPath,trials(t).name);                    
                    end
                end
            end
        end               
