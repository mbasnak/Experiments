...
%This code pools the data from single flies in experiment 3 (coming from
%the single trial analysis) and does some pooled analyses.

clear all; close all;

%% Around jump velocities

files = dir('Z:\Wilson Lab\Mel\Experiments\Exp3\data\*\*\*\perTrialData.mat');
...
%axis, so I need to negate the velocity data to obtain the actual forward
%vel
for i = 1:length(files)
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\AverageVelocityChange.png'))
...
for i = 1:length(around45)
    plot([1,2],[around45(1,i) around45(2,i)],'color',[0.5 0.5 0.5]) %add lines to join them
end
plot([1,2], [mean(around45(1,:)) mean(around45(2,:))],'k','lineWidth',2)
...
for i = 1:length(aroundNeg45)
    plot([1,2],[aroundNeg45(1,i) aroundNeg45(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(aroundNeg45(1,:)) mean(aroundNeg45(2,:))],'k','lineWidth',2)
...
for i = 1:length(around90)
    plot([1,2],[around90(1,i) around90(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(around90(1,:)) mean(around90(2,:))],'k','lineWidth',2)
...
for i = 1:length(aroundNeg90)
    plot([1,2],[aroundNeg90(1,i) aroundNeg90(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(aroundNeg90(1,:)) mean(aroundNeg90(2,:))],'k','lineWidth',2)
...
for i = 1:length(around45Ang)
    plot([1,2],[around45Ang(1,i) around45Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(around45Ang(1,:)) mean(around45Ang(2,:))],'k','lineWidth',2)
...
for i = 1:length(aroundNeg45Ang)
    plot([1,2],[aroundNeg45Ang(1,i) aroundNeg45Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(aroundNeg45Ang(1,:)) mean(aroundNeg45Ang(2,:))],'k','lineWidth',2)
...
for i = 1:length(around90Ang)
    plot([1,2],[around90Ang(1,i) around90Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(around90Ang(1,:)) mean(around90Ang(2,:))],'k','lineWidth',2)
...
for i = 1:length(aroundNeg90Ang)
    plot([1,2],[aroundNeg90Ang(1,i) aroundNeg90Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2], [mean(aroundNeg90Ang(1,:)) mean(aroundNeg90Ang(2,:))],'k','lineWidth',2)
text(1,max(max(aroundNeg90Ang)),strcat('p = ',num2str(p8)))
set(gca,'xticklabel',{[]})
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\QuantVelChange.png'))
...
Files = dir('Z:\Wilson Lab\Mel\Experiments\Exp3\data\*\*\*\goals.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\GoalDistribution.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\Dist2goal.png'))
...
Files = dir('Z:\Wilson Lab\Mel\Experiments\Exp3\data\*\*\flyData.mat');
...
TimeStamp{i} = datetime(Files(i).date);
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\FactorEffects.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\menotacticCorr.png'))

%% Distance to the goal in the 100 sec around the jumps

Files = dir('Z:\Wilson Lab\Mel\Experiments\Exp3\data\*\*\*\shortData.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\Dist2Goal100sec.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\AverageVelocityChangeGoodFlies.png'))
...
for i = 1:length(Garound45)
    plot([1,2],[Garound45(1,i) Garound45(2,i)],'color',[0.5 0.5 0.5]) %add lines to join them
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
ylabel('Forward velocity (mm/s)');
title('45 deg jumps')
...
for i = 1:length(GaroundNeg45)
    plot([1,2],[GaroundNeg45(1,i) GaroundNeg45(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
...
for i = 1:length(Garound90)
    plot([1,2],[Garound90(1,i) Garound90(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
...
for i = 1:length(GaroundNeg90)
    plot([1,2],[GaroundNeg90(1,i) GaroundNeg90(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
...
for i = 1:length(Garound45Ang)
    plot([1,2],[Garound45Ang(1,i) Garound45Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
ylabel('Angular velocity (deg/s)');
...
for i = 1:length(GaroundNeg45Ang)
    plot([1,2],[GaroundNeg45Ang(1,i) GaroundNeg45Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
...
for i = 1:length(Garound90Ang)
    plot([1,2],[Garound90Ang(1,i) Garound90Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
...
for i = 1:length(GaroundNeg90Ang)
    plot([1,2],[GaroundNeg90Ang(1,i) GaroundNeg90Ang(2,i)],'color',[0.5 0.5 0.5])
end
plot([1,2],[mean(Garound45(1,:)) mean(Garound45(2,:))],'k','lineWidth',2)
text(1,max(max(GaroundNeg90Ang)),strcat('p = ',num2str(p8)))
set(gca,'xticklabel',{[]})

saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp3\globalPlots\QuantVelChangeGoodFlies.png'))
