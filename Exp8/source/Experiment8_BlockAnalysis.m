...
saveas(gcf,strcat(path(1:end-16),'plots\Dist2GoalAllBlocks.png'))
...
saveas(gcf,strcat(path(1:end-16),'plots\ActivityRPAllBlocks.png'))
...
saveas(gcf,strcat(path(1:end-16),'plots\FlyHeadingAllBlocks.png'))
...
saveas(gcf,strcat(path(1:end-16),'plots\AJangvelAllBlocks.png'))
...
saveas(gcf,strcat(path(1:end-16),'plots\Neg90degAngvelHeatMap.png'))
...
suptitle('Ang Vel Heatmap for 90 jumps');
saveas(gcf,strcat(path(1:end-16),'plots\90degAngvelHeatMap.png'))
...
saveas(gcf,strcat(path(1:end-16),'plots\Dist2Goal3secAllBlocks.png'))