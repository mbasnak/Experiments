...
AFirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp8\data\03-Apr-2019\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp3.mat');
AHighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp8\data\03-Apr-2019\experimental flies\*\dataFromAnalysis\ActivityHigherErrorBlockExp4.mat');
ASecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp8\data\03-Apr-2019\experimental flies\*\dataFromAnalysis\ActivityHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp8\globalPlots\ActivityAcrossBlocks.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp8\globalPlots\StateTransitions.png'))

%% Around jump velocities

FirstLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp8\data\03-Apr-2019\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp3.mat');
HighErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp8\data\03-Apr-2019\experimental flies\*\dataFromAnalysis\perTrialDataHigherErrorBlockExp4.mat');
SecondLowErrorBlock = dir('Z:\Wilson Lab\Mel\Experiments\Exp8\data\03-Apr-2019\experimental flies\*\dataFromAnalysis\perTrialDataHighErrorBlockExp5.mat');
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp8\globalPlots\AverageVelocityChange.png'))
...
saveas(gcf,strcat('Z:\Wilson Lab\Mel\Experiments\Exp8\globalPlots\AverageVelocityProgressionHE.png'))
