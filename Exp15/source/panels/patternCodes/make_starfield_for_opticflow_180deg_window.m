...
writerObj = VideoWriter('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment15\stimVideos\rotationalFlowStarfield.avi');
...
for y = 2:pattern.y_num
        ...
        for i = 71:96
            Pats(:,i,[1:7,50:55],y) = Pats(:,i-1,[1:7,50:55],y-1);
        end
        ...
        Pats(:,70,[1:7,50:55],y) = Pats(:,21,[1:7,50:55],y-1);
        Pats(:,1,[1:7,50:55],y) = Pats(:,96,[1:7,50:55],y-1);
...
% create the video writer with 1 fps
writerObj = VideoWriter('Z:\Wilson Lab\Mel\FlyOnTheBall\data\Experiment15\stimVideos\FtoBStarfield.avi');
writerObj.FrameRate = 1; % set the seconds per image
% open the video writer
open(writerObj);
% write the frames to the video
...
directory_name = 'C:\Users\Wilson\Desktop\panels-matlab_071618\Patterns\mel360_36panels';
 str = [directory_name '\Pattern030_starfield_360_XY_opticflow180deg_30degwindow']; 	% name must begin with ‘Pattern_’
 save(str, 'pattern');