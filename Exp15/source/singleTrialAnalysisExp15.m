...
function singleTrialAnalysisExp15(path,file)
...
saveas(gcf,strcat(path,'plots\AR_ExpNum', file(11:end-4), '.png'))
close;
...
saveas(gcf,strcat(path,'plots\StimPositionWithWindow_',file(4:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\FlyPositionWithWindow_',file(4:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\Dist2goal_',file(4:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\Trajectory_',file(4:end-4),'.png'));
close;
