function singleTrialAnalysisExp12(path,file)
load([path,file]);
...
saveas(gcf,strcat(path,'plots\FlyHeading',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\AJangularvelocity',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\AbsAJangularvelocity',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\AbsAJangularvelocity2',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\ResponseMagvsJumpMag',file(1:end-4),'.png'));
close;

%% Around the jumps for the jump going back to closed loop

panelsON2 = panelsON(2:end);
jumpData2 = getDataAroundJump(rawData,panelsON2,3,9,sampleRate);
...
saveas(gcf,strcat(path,'plots\AJBackClosedAngularvelocity',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\AbsAJBacktoClosedangularvelocity',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\AbsAJBacktoClosedangularvelocity2',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\ResponseMagvsJumpMagBackToClosed',file(1:end-4),'.png'));
close;
