...
if sessions.initial_cl_wind < sessions.initial_cl_bar
    ...
    subplot(1,5,1)
    polarhistogram(pre_wind_offset_above_thresh,20,'FaceColor',fly_color)
    title('Initial wind offset');
    set(gca,'ThetaZeroLocation','top');
    
    subplot(1,5,2)
    polarhistogram(pre_panels_offset_above_thresh,20,'FaceColor',fly_color)
    title('Initial panels offset');
    set(gca,'ThetaZeroLocation','top');
    
    subplot(1,5,3)
    polarhistogram(combined_offset_above_thresh,20,'FaceColor',fly_color)
    title('Cue combination offset');
    set(gca,'ThetaZeroLocation','top');
    
    subplot(1,5,4)
    polarhistogram(post_wind_offset_above_thresh,20,'FaceColor',fly_color)
    title('Final wind offset');
    set(gca,'ThetaZeroLocation','top');
    
    subplot(1,5,5)
    polarhistogram(post_panels_offset_above_thresh,20,'FaceColor',fly_color)
    title('Final panels offset');
    set(gca,'ThetaZeroLocation','top');
...
if sessions.initial_cl_wind < sessions.initial_cl_bar
    ...
    offset_var = [offset_var_pre_wind_offset_above_thresh,offset_var_pre_panels_offset_above_thresh,offset_var_combined_offset_above_thresh,offset_var_post_wind_offset_above_thresh,offset_var_post_panels_offset_above_thresh];
    
elseif sessions.initial_cl_wind > sessions.initial_cl_bar
    
    offset_var = [offset_var_pre_panels_offset_above_thresh,offset_var_pre_wind_offset_above_thresh,offset_var_combined_offset_above_thresh,offset_var_post_panels_offset_above_thresh,offset_var_post_wind_offset_above_thresh];
