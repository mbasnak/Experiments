...
for folder = 1:length(foldernames)
    if contains(foldernames(folder).name,'60D05')
        ...
        allBumpPos = continuous_data.bump_pos;
        allGof = continuous_data.adj_rs;
        ...
        allBumpPos = [allBumpPos,continuous_data.bump_pos];
        allGof = [allGof,continuous_data.adj_rs];
