...
%save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopHeatmapAndOffset.png']);
...
%save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopOffsetVariation.png']);
...
%4) Save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopBMinTime.png']);
...
%save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopMeanBMNewMethod.png']);  
...
%Save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopMeanHWNewMethod.png']);
...
%save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopBMVelPerContrastBinned.png']);
...
%save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopHWNewMethodvsVelPerContrastBinned.png']);
...
%save figure
saveas(gcf,[path,'\analysis\continuous_plots\closedLoopHeadingVariation.png']);
