...
%Combine the tables into one
allModelData = array2table(zeros(0,12),'VariableNames', {'ContrastLevel','ForVelocity','ZscoredForVel','SideSpeed','ZscoredSideSpeed','YawSpeed','ZscoredYawSpeed','TotalMovement','ZscoredTotalMovement','Time','BumpMagnitude','BumpWidth'});
Fly = [];
for fly = 1:length(data)
...
allModelData.Properties.VariableNames{'Var13'} = 'Fly';
