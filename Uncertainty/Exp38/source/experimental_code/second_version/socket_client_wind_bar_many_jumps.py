...
class SocketClientWindBarManyJumps(object):
         ...
         serial.Serial(self.COM, self.baudrate, timeout=self.serialTimeout) as ser:
            ...
            while not self.done:
                ...
                if ready[0]:
                    ...
                    if ((math.floor(self.time_elapsed)==1680 or math.floor(self.time_elapsed)==2280 or math.floor(self.time_elapsed)==2880) and (self.bar_jump == True)):
                    ...
                    if ((math.floor(self.time_elapsed)==2279 or math.floor(self.time_elapsed)==2879) and (self.bar_jump == False)):
                        self.bar_jump = True
                    ...
                    if ((math.floor(self.time_elapsed)==1380 or math.floor(self.time_elapsed)==1980 or math.floor(self.time_elapsed)==2580) and (self.wind_jump == True)):
                   ...
                   #reset self.jump 1 sec before the wind jump has to happen
                    if ((math.floor(self.time_elapsed)==1979 or math.floor(self.time_elapsed)==2579) and (self.wind_jump == False)):
                        self.wind_jump = True
                    ...
                    #turn off the bar
                    if ((math.floor(self.time_elapsed)==1020 or math.floor(self.time_elapsed)== 3000) and (self.bar == True)):
                        self.bar = False
                    #turn on the bar
                    if ((math.floor(self.time_elapsed)==600 or math.floor(self.time_elapsed)==1140) and (self.bar == False)):
                        self.bar = True
                    ...
                    #turn on the wind
                    if ((math.floor(self.time_elapsed)==900 or math.floor(self.time_elapsed)==1260) and (self.wind == False)):
                        self.wind = True
                    #turn off the wind
                    if ((math.floor(self.time_elapsed)==600 or math.floor(self.time_elapsed)==1140 or math.floor(self.time_elapsed)==3000) and (self.wind == True)):                    
                        self.wind = False
