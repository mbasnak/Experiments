...
modelTable = table(offset_variability,heading_offset_variability,smoothed_bar_offset_variability,smoothed_heading_offset_variability,data.total_mvt_ds(1:length(allBumpMag))',zscored_total_mvt(1:length(allBumpMag))',data.time(1:length(allBumpMag)),allBumpMag',allHalfWidth',allZBumpMag',allZHalfWidth','VariableNames',{'BarOffsetVariability','HeadingOffsetVariability','SmoothBarOffsetVariability','SmoothHeadingOffsetVariability','TotalMovement','ZscoredTotalMovement','Time','BumpMagnitude','BumpWidth','ZBumpMagnitude','ZBumpWidth'});
