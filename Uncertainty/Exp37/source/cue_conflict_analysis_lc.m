...
load([path,'\analysis\continuous_analysis_sid_',num2str(sessions.cue_conflict_low_contrast),'_tid_0.mat'])
...
%save plot
saveas(gcf,[path,'\analysis\plots\summary_results_low_contrast.png']);
...
%save plot
saveas(gcf,[path,'\analysis\plots\offsets_low_contrast.png']);
...
for jump = 1:length(j)
   ...
   saveas(gcf,[path,'\analysis\plots\AJ_bump_magnitude_lc_',num2str(jump),'.png']);
...
for jump = 1:length(j)
   ...
   saveas(gcf,[path,'\analysis\plots\AJ_bump_width_lc_',num2str(jump),'.png']);
...
saveas(gcf,[path,'\analysis\plots\AJ_bump_parameters_low_contrast.png']);
...
saveas(gcf,[path,'\analysis\plots\AJ_mean_yaw_vel_lc.png']);
