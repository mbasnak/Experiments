...
number_x = 96;
if run_obj.function_number == 218 %if we're using a function to make the bar jump
    [smoothed, bdata_time_out, panel_angle, flyPosRad, motor_pos] = correct_bar_jumps(bdata_time, bdata_raw, number_x);
else
