%function to run the analysis for a single trial of exp 1, in which flies where in closed-loop
% with a bar for different time periods

function singleTrialAnalysis(path,file)
