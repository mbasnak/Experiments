%Code to calculate the distance to the goal for the data pooled from all
%flies


cd 'Z:\Wilson Lab\Mel\Experiments\Exp1\data'
load('angularPositionAllFlies.mat')
...
saveas(gcf,'Z:\Wilson Lab\Mel\Experiments\Exp1\globalPlots\dist2goal.png');
