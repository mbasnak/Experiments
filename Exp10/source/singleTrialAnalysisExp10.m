function singleTrialAnalysisExp10(path,file)
...
save([path,'dataFromAnalysis\AngularVelocityClockwise',file(1:end-4),'.mat'],'angularVelocityClockwise');
save([path,'dataFromAnalysis\AngularVelocityCounterclockwise',file(1:end-4),'.mat'],'angularVelocityCounterclockwise');
...
saveas(gcf,strcat(path,'plots\ClosedLoopTrajectories',file(1:end-4),'.png'));
close;
...
saveas(gcf,strcat(path,'plots\FlyPositionClosedLoop',file(1:end-4),'.png'))
close;
...
saveas(gcf,strcat(path,'plots\FlyPositionClosedLoopMovingFrames',file(1:end-4),'.png'))
close;
...
saveas(gcf,strcat(path,'plots\ClockwiseTaus',file(1:end-4),'.png'))
close;
...
saveas(gcf,strcat(path,'plots\ClockwiseResponseEv',file(1:end-4),'.png'))
close;
...
saveas(gcf,strcat(path,'plots\CounterclockwiseTaus',file(1:end-4),'.png'))
close;
...
saveas(gcf,strcat(path,'plots\CounterclockwiseResponseEv',file(1:end-4),'.png'))
close;

%save both responses 
save([path,'dataFromAnalysis\Responses',file(1:end-4),'.mat'],'response','responseCC');
...
saveas(gcf,strcat(path,'plots\AllResponsesEv',file(1:end-4),'.png'))
close;
...
saveas(gcf,strcat(path,'plots\PCA',file(1:end-4),'.png'))
close;
