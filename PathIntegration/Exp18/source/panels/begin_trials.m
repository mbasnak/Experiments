...
%     else
%         if sum(probeTrials == i) == 0 %if this is not a probe trial
%             if sum(emptyTrials == i) == 0 %if this is not an empty trial (it's a regular trial)
%                 [trial_bdata, trial_time] = run_trial_vHallway(i, cur_task, run_obj, scanimage_client_skt, cur_trial_corename );
%             else %if it's an empty trial
...
%             end
%         else %if this is a probe trial
%             [trial_bdata, trial_time] = run_trial_vHallway_probe(i, cur_task, run_obj, scanimage_client_skt, cur_trial_corename );            
%             disp('This is a probe trial')
%         end
...
%     end
    ...
    if run_obj.experiment_number ~= 7
        ...
        if sum(emptyTrials == i) == 1 %if this is an empty trial
           [trial_bdata, trial_time] = run_empty_trial(i, cur_task, run_obj, scanimage_client_skt, cur_trial_corename);
           disp('This is an empty trial')
