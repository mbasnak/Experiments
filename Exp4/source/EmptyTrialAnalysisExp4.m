...
function EmptyTrialAnalysisExp4(path,file)
...
saveas(gcf,strcat(path,'plots\ForwardVelocity_EmptyTrial.png'))
close
...
saveas(gcf,strcat(path,'plots\AngularVelocity_EmptyTrial.png'))
close
...
saveas(gcf,strcat(path,'plots\AR_EmptyTrial.png'))
close
...
saveas(gcf,strcat(path,'plots\FlyPosition_EmptyTrial.png'))
close
...
save(strcat(path,'\dataFromAnalysis\EmptyTrialGoals.mat'),'goal','goalMoving','dist2goal','dist2goalMoving');
saveas(gcf,strcat(path,'plots\Dist2goal_EmptyTrial.png'))
close
